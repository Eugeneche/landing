...
const Form = (props) => {
    ...
    const [ pointInMessage, setPointInMessage ] = useState('')

    useEffect(() => {       
        setPointInMessage(`Point #${props.point.id}, address: ${props.point.city}, ${props.point.street}, PSČ: ${props.point.zip}, ${props.point.url}`)
    })
  ...
  return (
    <form className={styles.form} ref={form} onSubmit={sendEmail}>
        <div className={styles.fields}>
            ...
            <textarea className={styles.order} name="point" defaultValue={pointInMessage}></textarea>
